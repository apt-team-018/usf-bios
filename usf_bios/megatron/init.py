...
from usf_bios.utils import (get_logger, git_clone_github, is_flash_attn_3_available, is_megatron_available,
...
def _patch_transformer_engine():
    ...
    try:
        ...
        try:
            ...
            logger.info_debug('Patch apply_rotary_pos_emb successfully applied.')
    ...
    try:
        ...
        try:
            ...
            logger.info_debug('Patch _SplitAlongDim successfully applied.')
        except (ImportError, AttributeError):
            pass
...
def _patch_megatron():
    os.environ.pop('VLLM_USE_HF', None)
    ...
    from usf_bios.megatron import tuners  # patch lora
    try:
        _patch_torch_FileSystemReader()
        logger.info_debug('Patch FileSystemReader successfully applied.')
    except Exception:
        pass
    try:
    ...
    try:
        ...
        logger.info_debug('Patch peft successfully applied.')
    except Exception:
        pass

    import megatron.core
    logger.info_debug(f'megatron.core.__version__: {megatron.core.__version__}')
