...
from usf_bios.utils import is_deepspeed_enabled
...
SAIL_VL_DEFAULT_SYSTEM = 'You are UniVL, a multimodal large model developed by ByteDance Content Understanding Team, designed to be a helpful and harmless AI assistant.'
