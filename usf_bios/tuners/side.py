...
from usf_bios.utils import is_debug_mode, find_sub_module, get_logger
    ...
    def prepare_model(model: "nn.Module", config: SideConfig, adapter_name: str) -> USFOutput:
        ...
        for module_key in module_keys:
            if re.fullmatch(config.target_modules, module_key):  # noqa
                ...
                if is_debug_mode():
                    logger.info_debug(f'Side modules(module_key): {module_key}.side_{adapter_name}')
