...
from usf_bios.utils import (HfConfigFactory, deep_getattr, get_device_count, get_dist_setting, get_last_valid_indices,
...
def patch_automodel_for_sequence_classification(model_info=None,
    ...
    # https://github.com/us-inc/usf-bios/pull/5820
    patched_classes = []
...
def gather_sequence_parallel_outputs(
    ...
    """
        ...
        """
    from usf_bios.sequence_parallel import sequence_parallel, GatherTensor
